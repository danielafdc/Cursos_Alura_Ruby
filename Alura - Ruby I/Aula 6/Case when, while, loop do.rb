...
def sorteia_numero_secreto(dificuldade)
	...
	sorteado = rand(maximo) + 1 #escolher o número aleatório entre 0 e 199
...
#comentando todo o código para poder fazer o inverso e usar o loop do
#def quer_jogar
...
#
#while quer_jogar #o laço while primeiro executa a condição (primeiro ele pergunta), para depois executar o código
	##então eu uso o loop do, e nesse código eu precisarei inverter as coisas....
